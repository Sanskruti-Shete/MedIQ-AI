...
const CATEGORIES = [
  ...
  { id: "general", name: "General Medicine", icon: Stethoscope, color: "text-emerald-500" },
  { id: "orthopedics", name: "Orthopedics", icon: Bone, color: "text-blue-500" },
  { id: "ophthalmology", name: "Ophthalmology", icon: Eye, color: "text-teal-500" },
  { id: "pharmacology", name: "Pharmacology", icon: Pill, color: "text-orange-500" },
]
...
const SAMPLE_ARTICLES: KnowledgeArticle[] = [
  {
    ...
    category: "cardiology",
    summary: "Comprehensive guide to high blood pressure management and prevention strategies.",
    content: "Hypertension, commonly known as high blood pressure, affects millions worldwide...",
  ...
  },
  {
    ...
    category: "neurology",
    summary: "Latest evidence-based treatments for migraine prevention and acute management.",
    content: "Migraines are complex neurological disorders that require comprehensive treatment...",
  ...
  },
  {
    ...
    category: "general",
    summary: "Evidence-based approach to managing type 2 diabetes through lifestyle and medication.",
    content: "Type 2 diabetes management requires a multifaceted approach combining lifestyle modifications...",
  ...
  },
  {
    ...
    summary: "Essential guide to identifying and managing drug interactions in clinical practice.",
    content: "Drug interactions are a significant concern in clinical practice, especially in patients...",
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              {(() => {
                ...
                return <Icon className={`w-5 h-5 ${category?.color || "text-emerald-500"}`} />
              })()}
              <Badge variant="outline">
                {getCategoryInfo(selectedArticle.category)?.name || selectedArticle.category}
              </Badge>
            ...
            <div className="bg-white rounded-lg border p-6">
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-800">
                  ...
                  replace professional medical advice. Always consult with a qualified healthcare provider for diagnosis
                  and treatment.
                </p>
              </div>
            </div>
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-emerald-600">Evidence-based medical information and clinical guidelines</p>
      </div>
                  ...
                  <CardContent className="p-6" onClick={() => setSelectedArticle(article)}>
                    <div className="flex items-start justify-between">
                      <div className="flex-1 space-y-3">
                        <div className="flex items-center gap-2">
                          <Icon className={`w-5 h-5 ${category?.color || "text-emerald-500"}`} />
